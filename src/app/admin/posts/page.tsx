...
import { Plus, Edit, Trash2, Search, ExternalLink, Loader2, Filter } from "lucide-react";
                ...
                filteredPosts.map((post) => (
                  <tr key={post.id} className="hover:bg-white/5 transition-colors group">
                    <td className="px-6 py-5">
                      <Link href={`/admin/posts/edit/${post.slug}`} className="flex items-center gap-4 group/item">
                    ...
                    <td className="px-6 py-5">
                      <div className="flex flex-col gap-2 items-start">
                        ...
                        {post.featured && (
                          <span className="inline-flex items-center gap-1.5 text-xs font-bold text-[#ffa500] bg-[#ffa50010] px-3 py-1 rounded-full">
                            <div className="w-1.5 h-1.5 rounded-full bg-[#ffa500]" /> Featured
                          </span>
                        )}
                      </div>
                    </td>
